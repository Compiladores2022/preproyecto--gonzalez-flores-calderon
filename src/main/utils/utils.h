...
typedef enum {ADD, SUB, MULT, DIV, MOD, AND, OR, NOT, ASSIG, EQUAL, GREAT, LESS, RET, METHDECL, EXTERNMETH, METHCALL, IF, IFELSE, WHILE, NEXTBLOCK, PUSH, JMP, JMPFALSE, JMPTRUE} operations;
